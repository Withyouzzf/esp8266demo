...
ifeq ($(app), 0)
	...
	@echo -e "\033[2J \033[0m"
		...
		@echo -e "\033[1m\033[36m ###\033[1m\033[36m               果云科技               \033[36m###\033[0m"
		@echo -e "\033[1m\033[36m ###\033[1m\033[33m            乐鑫 NONOS SDK            \033[36m###\033[0m"
		@echo -e "\033[1m\033[36m ###\033[1m\033[31m              VERSON 2.0              \033[36m###\033[0m"
		@echo -e "\033[1m\033[36m###############################################\033[0m"
		@echo -e "\033[0m"
		@echo -e "\033[1m\033[33m    Bin文件合成成功，请注意新版本下              \033[0m"
		@echo -e "\033[1m\033[33m    eagle.irom0text.bin 文件烧录地址是 0x10000   \033[0m"
		@echo -e "  "
